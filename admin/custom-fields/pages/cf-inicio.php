                ...
                Field::make('complex', 'campo_radio', __('Grupo de Radio Buttons'))
                    ...
                    ->add_fields(array(
                        ...
                        Field::make('text', 'radio_subopcion_valor', __('Identificador de las opciones'))
                            ->set_help_text('Ejm: nModalidad, nSubPrograma, nPrograma')
                            ->set_width(50),
                        Field::make('checkbox', 'radio_check_activar_campos', __('1er ¿Deseas abrir campos que dependan de esta selección?'))
                            ->set_option_value('1'),
                        //SI
                        Field::make('select', 'radio_campos', __('Elegir campo'))
                            ->set_width(100)
                            ->set_options([
                                '1' => 'Campo de Texto',
                            ...
                            //PLACEHOLDER
                            Field::make('text', 'r_one_place', 'Título del campo')
                                ->set_help_text('Guía para el usuario de lo que debe hacer en el campo; Ejm: Apellidos o Escribe tu nombre')
                                ->set_width(100)
                                ->set_required(true)
                                ->set_conditional_logic([
                            ...
                            //IDENTIFICADOR
                            Field::make('text', 'r_one_name', 'Identificador del campo')
                                ->set_help_text('Ejm: cApellido')
                                ->set_width(27) 
                                ->set_conditional_logic([
                                    'relation' => 'AND',
                                    [
                            ...
                            //VALUE
                            Field::make('text', 'r_one_value', 'Dato/código guardado o a guardar')
                                ->set_help_text('Ejm: 0, 10, 21, 17')
                                ->set_width(27)
                                ->set_conditional_logic([
                                    'relation' => 'AND',
                            ...
                            //TAMAÑO DE CAMPO
                            Field::make('select', 'r_one_tamano_campo', 'Tamaño')
                                ->set_width(8)
                                ->set_conditional_logic(array(
                                    'relation' => 'AND',
                                    array(
                            ...
                            Field::make('text', 'r_one_select_name_option', 'Identificador de las opciones')
                                ->set_help_text('nModalidad, nSubPrograma, nPrograma')
                                ->set_width(50)
                                ->set_required(true)
                                ->set_conditional_logic([
                                    'relation' => 'AND',
                                    ...
                                    [
                                        'field' => 'r_two_check_activar_campos',
                                        'value' => '1',
                                        'compare' => '=',
                                    ],
                                ]),
                            //nombre del campo
                            Field::make('text', 'r_one_select_name', 'Identificador del campo')
                            ...
                            Field::make('text', 'r_one_select_place', 'Primer texto del seleccionable')
                                ->set_help_text('Este es el primer tetxo del seleccionable')
                                ->set_width(27)
                                ->set_required(true)
                                ->set_conditional_logic([
                                    'relation' => 'AND',
                            ...
                            //2do CHECK MAS CAMPOS DEL CAMPO OCULTO
                            
                                Field::make('checkbox', 'r_two_check_activar_campos', __('2do ¿Deseas abrir campos que dependan de esta selección?'))
                                ->set_option_value('1') // Asegurar que guarde '1' en lugar de 'true'
                                ->set_width(100)
                                ->set_help_text('Marca esta opción para mostrar mas opciones de campos')
                                ->set_conditional_logic([
                                    'relation' => 'AND',
                                    [
                                        'field' => 'radio_check_activar_campos',
                            ...
                            //COMPLEX CON CAMPOS PARA SELECCIONABLE  INTERMEDIO SIN VALOR
                            Field::make('complex', 'r_two_select', __('Campo de selección'))
                                ->setup_labels(['plural_name' => 'Selecciones', 'singular_name' => 'Selección'])
                                ->set_help_text('Agregar Items al Seleccionable')
                                ->set_width(100)
                                ->set_layout('tabbed-vertical')
                                ...
                                ->add_fields(array(
                                    //PLACEHOLDER - TEXT PARA ESCRIBIR LA PRIMERA OPCION DEL SELECT 
                                    Field::make('text', 'r_two_select_placeholder', __('Nombre del seleccionable'))
                                        ->set_help_text('El valor que se agregue aquí, viajará con el nombre del "Identificador del campo"')
                                        ->set_width(50),
                                    
                                    //VALUE - TEXT PARA ESCRIBIR EL CODIGO A GUARDAR
                                    Field::make('text', 'r_two_select_value', __('Texto o código a guardar'))
                                        ->set_help_text('El valor que se agregue aquí, viajará con el nombre del "Identificador de las opciones"')
                                        ->set_width(50),
                                    //CAMPO TEXTO - VALUE CODIGO DE FORMULARIO (Para tipo: select)
                                    Field::make('text', 'r_two_cod_form', 'Código de formulario para el flujo')
                                        ->set_help_text('Ejm: Aquí solo viajará el ---> cCodFormExterno')
                                        ->set_width(50),
                                    //CHECKBOX - PARA ACTIVAR MAS CAMPOS DENTRO DEL SELECT
                                    Field::make('checkbox', 'r_two_check_activar_campos', __('¿Deseas abrir campos que dependan de esta selección?'))
                                        ->set_option_value('1') // Asegurar que guarde '1' en lugar de 'true'
                                        ->set_help_text('Marca esta opción para mostrar las carreras/programas.'),     
                                    //SELECCIONABLE DE CAMPOS SI MARCA LA OPCION SI ARRIBA
                                    Field::make('select', 'r_two_campos_subselect', __('Elige el tipo de campo que se abrirá al hacer clic en la opción del select'))
                                        ...
                                        //PARA TIPO TEXTO    
                                            //PLACEHOLDER DE CAMPO TEXTO - NOMBRE DEL CAMPO
                                            Field::make('text', 'r_two_subselect_text_place', 'Título del campo')
                                                ->set_help_text('Guía para el usuario de lo que debe hacer en el campo; Ejm: Apellidos o Escribe tu nombre')
                                                ->set_width(50)
                                                ->set_required(true)
                                                ->set_conditional_logic([
                                            ...
                                            //CAMPO TEXTO - NAME (Para tipo: text, select, radio, hidden, select carreras)
                                            Field::make('text', 'r_two_subselect_text_name', 'Identificador del campo')
                                                ->set_help_text('Ejm: cModalidad, cSubPrograma')
                                                ->set_width(50) 
                                                ->set_required(true)
                                                ->set_conditional_logic([
                                        ...
                                        //PARA TIPO SELECCIÓN DE CARRERAS
                                            //ASOCIACION DE CARRERAS
                                            Field::make('association', 'r_two_subselect_carreras', 'Carreras') 
                                                ->set_help_text('Selecciona las carreras/programas que aparecerán en el select')
                                                ->set_width(100)
                                                ->set_types([
                                                    [
                                        ...
                                        //PARA TIPO  SELECCION SIMPLE   - SUB NIVEL SELECCIÓN 1
                                            //CAMPO TEXTO - NOMBRE DE la PRIMERA OPCION DEL CAMPO SELECCION (primera opción) (Para tipo: select)
                                            Field::make('text', 'r_two_subselect_select_place', 'Nombre del seleccionable')
                                                ->set_help_text('Aparecerá como primera opción del select, pero será NO SELECCIONABLE, es un título')
                                                ->set_width(27)
                                                ->set_required(true)
                                                ->set_conditional_logic([
                                            ...
                                            //CAMPO TEXTO - NAME (Para tipo: text, select, radio, hidden, select carreras)
                                            Field::make('text', 'r_two_subselect_select_name', 'Identificador del campo')
                                                ->set_help_text('Ejm: cApellidos, cCelular, cCodFormExterno, cCarrera, cModalidad, cSubPrograma')
                                                ->set_width(27) 
                                                ->set_required(true)
                                                ->set_conditional_logic([
                                            ...
                                            //CAMPO TEXTO - NAME DE LAS OPCIONES DE UN SELECT (Para tipo: select)
                                            Field::make('text', 'r_two_subselect_select_nameseleccion', 'Identificador de las opciones')
                                                ->set_help_text('Ejm: nModalidad,nSubPrograma')
                                                ->set_width(50)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                            ...
                                            //CAMPO SELECCIONABLE TAMAÑO - ELECCION DE TAMAÑO DE CAMPO (1,3)
                                            Field::make('select', 'r_two_subselect_tamano', 'Tamaño')
                                                ->set_width(50)
                                                ->set_required(true)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                            ...
                                            Field::make('complex', 'r_two_subselect_select', 'Campo de selección')
                                                ...
                                                ->add_fields(array(   
                                                    //CAMPO TEXTO - NOMBRE DE la PRIMERA OPCION DEL CAMPO SELECCION (primera opción) (Para tipo: select)
                                                    Field::make('text', 'r_two_subsubselect_select_place', 'Nombre del seleccionable')
                                                        ->set_help_text('Ejm: Modalidad, Horarios')
                                                        ->set_width(27)
                                                        ->set_required(true),
                                                    //CAMPO TEXTO - NAME (Para tipo: text, select, radio, hidden, select carreras)
                                                    Field::make('text', 'r_two_subsubselect_select_name', 'Texto o código a guardar')
                                                        ->set_help_text('Ejm: 0,1')
                                                        ->set_width(27) 
                                                        ->set_required(true),
                                                )),
                                        //PARA TIPO  SELECCION MULTIPLE  - SUB NIVEL SELECCIÓN 1
                                            //CAMPO TEXTO - NOMBRE DE la PRIMERA OPCION DEL CAMPO SELECCION (primera opción) (Para tipo: select)
                                            Field::make('text', 'r_two_submultiselect_select_place', 'Nombre del seleccionable')
                                                ->set_help_text('Aparecerá como primera opción del select, pero será NO SELECCIONABLE, es un título')
                                                ->set_width(27)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                            ...
                                            //CAMPO TEXTO - NAME (Para tipo: text, select, radio, hidden, select carreras)
                                            Field::make('text', 'r_two_submultiselect_select_name', 'Identificador de las opciones')
                                                ->set_help_text('Ejm: nModalidad, nSubPrograma, nPrograma')
                                                ->set_width(27)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                            ...
                                            //CAMPO TEXTO - NAME DE LAS OPCIONES DE UN SELECT (Para tipo: select)
                                            Field::make('text', 'r_two_submultiselect_select_nameseleccion', 'Identificador del campo')
                                                ->set_help_text('Ejm: cModalidad,cSubPrograma')
                                                ->set_width(50)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                            ...
                                            //CAMPO SELECCIONABLE TAMAÑO - ELECCION DE TAMAÑO DE CAMPO (1,3)
                                            Field::make('select', 'r_two_submultiselect_tamano', 'Tamaño')
                                                ->set_width(50)
                                                ->set_conditional_logic([
                                                    'relation' => 'AND',
                                                    [
                                            ...
                                            Field::make('complex', 'r_two_submultiselect_select', 'Campo de selección')
                                                ...
                                                ->add_fields(array(   
                                                    //CAMPO TEXTO - NOMBRE DE la PRIMERA OPCION DEL CAMPO SELECCION (primera opción) (Para tipo: select)
                                                    Field::make('text', 'r_two_subsubmultiselect_select_nombre', 'Nombre del seleccionable')
                                                        ->set_help_text('El valor que se agregue aquí, viajará con el nombre del "Identificador del campo"')
                                                        ->set_width(27),
                                                    //CAMPO TEXTO - NAME (Para tipo: text, select, radio, hidden, select carreras)
                                                    Field::make('text', 'r_two_subsubmultiselect_select_name', 'Texto o código a guardar')
                                                        ->set_help_text('El valor que se agregue aquí, viajará con el nombre del "Identificador de las opciones"')
                                                        ->set_width(27),
                                                    //CAMPO TEXTO PLACEHOLDER DE PROGRAMA SELECCIONADO
                                                    Field::make('text', 'r_two_subsubmultiselect_select_place', 'Primera opción del select')
                                                        ->set_help_text('Aparecerá como primera opción del select, pero será NO SELECCIONABLE, es un título')
                                                        ->set_width(100),
                                                    //CAMPO ASOCIACIÓN - CARRERAS
                                                    Field::make('association', 'r_two_subsubmultiselect_carreras', __('Escoger carreras'))
                                                        ->set_types([
                                                            [
                                                                'type'      => 'post',
                                                                'post_type' => 'carreras', 
                                ...
                                ->set_header_template('Opción <%- r_two_submultiselect_select_place %>'),

                            //CAMPO SELECCIONABLE PARA SELECCIONABLE INTERMEDIO CON VALOR
                            Field::make('complex', 'r_one_select', __('Campo de selección'))
                                ->setup_labels(['plural_name' => 'Selecciones', 'singular_name' => 'Selección'])
                                ->set_help_text('Agregar Items al Seleccionable')
                                ->set_width(100)
                                ->set_layout('tabbed-vertical')
